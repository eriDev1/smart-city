      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Smart City Big Data System: Real-Time Air Quality Monitoring with
          ...
          <Card className=" -200 ">
            ...
            <CardContent>
              <p className=" leading-relaxed">
                ...
                daily from 11,000+ global monitoring stations, implementing
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-700">
                    <strong>Smart City Big Data System</strong> - A
                    comprehensive real-time air quality monitoring and analytics
                ...
                <div>
                  ...
                  <p className="text-gray-700 mb-4">
                    Urban air pollution represents a critical challenge
                    affecting over 4 billion people globally. Current monitoring
